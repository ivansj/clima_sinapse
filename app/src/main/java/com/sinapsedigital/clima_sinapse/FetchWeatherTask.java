...
import com.sinapsedigital.clima_sinapse.data.WeatherContract;
import com.sinapsedigital.clima_sinapse.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(cursor.moveToFirst()){
            ...
            Uri retUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
            id = ContentUris.parseId(retUri);
        }
