...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        //uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY, WeatherContract.PATH_WEATHER + "/*/" + WeatherContract.WeatherEntry.COLUMN_DATE + "/#", WEATHER_WITH_LOCATION_AND_DATE);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        //  isso faz com que excluir todas as linhas retornar o número de linhas excluídas.
